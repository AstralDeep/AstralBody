#!/usr/bin/env python3
"""
MCP Server for ETF Tracker — dispatches tool calls to tool functions.
"""
import os
import sys
import json
...
from agents.etf_tracker_1.mcp_tools import TOOL_REGISTRY

logger = logging.getLogger('EtfTracker1AgentMCPServer')
