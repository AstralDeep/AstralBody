#!/usr/bin/env python3
"""
MCP Server for LinkedIn Engagement Driver Agent — dispatches tool calls to LinkedIn tool functions.
"""
import os
import sys
import json
...
from agents.linkedin.mcp_tools import TOOL_REGISTRY
...
class MCPServer:
    """Simple MCP server that routes tool/call requests to registered LinkedIn functions."""
