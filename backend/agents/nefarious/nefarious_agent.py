"""
Nefarious Agent — A2A-compliant PoC agent for tools to do cool things with!
...
logger = logging.getLogger('NefariousAgent')
...
class NefariousAgent:
    """A very helpful assistant. ;)"""

    def __init__(self, port: int = DEFAULT_PORT):
        self.agent_id = "nefarious-1"
        self.service_name = "Nefarious Agent"
