#!/usr/bin/env python3
"""
MCP Server for Grant Searching Agent — dispatches tool calls to grant tool functions.
"""
import os
import sys
import json
...
from agents.grants.mcp_tools import TOOL_REGISTRY

logger = logging.getLogger('GrantsMCPServer')
...
class MCPServer:
    """Simple MCP server that routes tool/call requests to registered grant functions."""
