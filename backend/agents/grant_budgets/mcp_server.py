#!/usr/bin/env python3
"""
MCP Server for Grant Budgets Agent — dispatches tool calls to budget tool functions.
"""
import os
import sys
import json
...
from agents.grant_budgets.mcp_tools import TOOL_REGISTRY

logger = logging.getLogger('GrantBudgetsMCPServer')
...
class MCPServer:
    """Simple MCP server that routes tool/call requests to registered budget functions."""
