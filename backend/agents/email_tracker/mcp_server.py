#!/usr/bin/env python3
"""
MCP Server for Email Tracker — dispatches tool calls to tool functions.
"""
import os
import sys
import json
...
from agents.email_tracker.mcp_tools import TOOL_REGISTRY

logger = logging.getLogger('EmailTrackerAgentMCPServer')
