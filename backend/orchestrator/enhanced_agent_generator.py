#!/usr/bin/env python3
"""
Enhanced Agent Generator with improved reliability and validation.
"""
import os
import sys
import uuid
...
logger = logging.getLogger("EnhancedAgentGenerator")


class EnhancedAgentGeneratorClient:
    """Enhanced agent generator with validation and failsafes."""
...
IMPORTANT: Each file content must be a valid Python script. Do NOT include markdown code fences in the JSON values."""
    ...
    def _extract_tool_descriptions(self, session: Dict) -> List[Dict]:
        ...
        # Matches phrases like "tool that can fetch weather" or "function to calculate sum"
...
# Singleton instance
enhanced_agent_generator = EnhancedAgentGeneratorClient()
...
if __name__ == "__main__":
    ...
    async def test():
        generator = EnhancedAgentGeneratorClient()
