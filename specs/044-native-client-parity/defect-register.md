...
| D-022 | P3 | Windows | Desktop verification screenshots render all text as tofu (offscreen platform + zero bundled/registered fonts; QWidget.grab in fontless env) — capture-environment hypothesis to be confirmed live | open → T052 | pending |
