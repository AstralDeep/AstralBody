...
- [ ] T050 [P] [US2] Vitest: simulating a sign-out (clearing the auth token in the test harness) does NOT remove `astraldeep.llm.config.v1` from localStorage — at [frontend/tests/hooks/useLlmConfig.test.ts](frontend/tests/hooks/useLlmConfig.test.ts) (extend file from T041)
